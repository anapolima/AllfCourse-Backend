CREATE TABLE public.users (
	...
	"recover_token" varchar(64) NOT NULL,
	"rtoken_expire" timestamp with time zone NOT NULL,
	"email_token" varchar(64) NOT NULL,
	"etoken_expire" timestamp with time zone NOT NULL,
	"type" int NOT NULL,
...
ALTER TABLE modules ADD CONSTRAINT "modules_fk0" FOREIGN KEY ("course_id") REFERENCES courses("id");
