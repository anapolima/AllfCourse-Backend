...
// Description: File responsible for the 'getSalesByStudentId' function of the 'sales' class controller
// Data: 2021/08/30
// Author: Allfcourse team
// -----------------------------------------------------------------------------------------------//

const query = require('@helpers/Query');
const checkStudent = require('@app/functions/checkIfStudentExists');
...
exports.getSalesByStudentId = async (req, res) => {
    ...
    if (studentId !== '0') {
        const check = await checkStudent.check(
            studentId,
        );
